...
<title>E-DriveThru Vending About</title>
...
<div class="col-md-9 ftco-animate text-center">
     <p class="breadcrumbs"><span class="mr-2"><a href="HomePage.php">Home</a></span>
...
<section class="ftco-section ftco-no-pb ftco-no-pt bg-black">
<div class="container">
<div class="row">
<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(image/cocaCola.jpg);">
     <a href="https://www.youtube.com/watch?v=RfjFDl32zQw" class="icon popup-vimeo d-flex justify-content-center align-items-center">
...
<div class="pb-md-5">
     <h5 class="mb-4" style="text-align:justify">Welcome to E-DriveThru Vending Website. E-DriveThru Vending is actually an e-commerce website that let people to easily grab their snacks and beverage on their chosen vending machine.
         They can place their order earlier and make their payment online.
         QR Code will be provided for them once payment has been made.
         Their order can be grab at their chosen vending by just let the vending to scan the QR Code provided earlier.
     </h5>
...
<section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(image/spindrift1.jpg);">    	
...
<strong class="number" data-number="100">0</strong>
     <span>Snack & Beverages Brand</span>
</div>
</div>
</div>
...
<strong class="number" data-number="1000">0</strong>
     <span>Vending Partner World Wide</span>
</div>
</div>
</div>
...
<div class="text">
<strong class="number" data-number="100">0</strong>
     <span>Supported E-Wallet payment</span>
</div>
</div>
</div>
</div>
...
<div class="text text-center">
     ...
     <p class="name">Iu</p>
     <span class="position">Atress</span>
</div>
</div>
</div>
