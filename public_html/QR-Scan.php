...
<title>E-DriveThru Vending QR Code Generate</title>
...
<div class="col-md-9 ftco-animate text-center">
     ...
     <h1 class="mb-0 bread">QR Code</h1>
</div>
</div>
</div>
</div>

<section class="ftco-section  py-5 bg-black">

<div class="row block-9 bg-black">
<form name="QRcodeForm" method="post" class="qr-form" style="align-items: center">

     <label>Your Order Number</label>
     <input type="text" name="qr" class="form-control" placeholder="Enter your order number" onblur='generateBarCode();' /> 

 
    <br><br>

    <img class="displayed" id="barcode" 
         src="https://api.qrserver.com/v1/create-qr-code/?data=HelloWorld&amp;size=500x400" 
         alt="" 
         title="Thank you for purchasing with E-DriveThru Vending"
         width="300" 
         height="300"
         align-item="center"
         text-align="center"
