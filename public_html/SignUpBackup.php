...
<form name="signupForm" onsubmit="return validateForm()" action="registration.php" method="post">
...
<div class="input-group">
     ...
     <input type="password" name="confirmPassword" maxlength="25" data-toggle="password">
...
<div class="error" id="confirmPasswordErr"></div>
    ...
    <br>
<div class="input-group">
    <button type="submit" name="login" class="btn btn-red align-items-center"> Login </button>
</div>
