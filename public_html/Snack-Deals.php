...
<title>E-DriveThru Vending Snack Deals</title>
...
<div class="col-md-9 ftco-animate text-center">
     <p class="breadcrumbs"><span class="mr-2"><a href="HomePage.php">Home</a></span> <span class="mr-2"><a href="Snack-Deals.php">Snack Deals</a></span></p>
     <h1 class="mb-0 bread">Snacks Deals</h1>
</div>
</div>
</div>
</div>
...
<div class="col-md-10 mb-5 text-center">
          <ul class="product-category">
              <li><a href="Snack-Deals.php"class="active">Snacks Deals of The Day!</a></li>
          </ul>
</div>
</div>
<div class="row">
