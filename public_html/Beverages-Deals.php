...
<title>E-DriveThru Vending Beverages Deals</title>
...
<div class="col-md-9 ftco-animate text-center">
     <p class="breadcrumbs"><span class="mr-2"><a href="HomePage.phpl">Home</a></span> <span class="mr-2"><a href="Beverages Deals.php">Beverages Deals </a></span></p>
     <h1 class="mb-0 bread">Beverages Deals</h1>
</div>
</div>
</div>
</div>
...
<div class="col-md-10 mb-5 text-center">
          ...
          <li><a href="Beverage-Deals.php"class="active">Beverages Deals of The Day!</a></li>
          </ul>
</div>
</div>
<div class="row">
