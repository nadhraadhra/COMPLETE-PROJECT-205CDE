...
<title>E-DriveThru Vending Login</title>
...
<div class="input-group">
     ...
     <input type="password" name="password" maxlength="25" data-toggle="password">
...
<span class="txt2">or sign in using</span>
</div>
...
// =========================== Defining error variables with a default value ==========================================================//
    ...
    var nameErr = usernameErr = emailErr = mobileErr = countryErr = passwordErr = confirmPasswordErr = true;
...
// =================  Prevent the form from being submitted if there are any errors===========================//
    ...
    if((nameErr || usernameErr || emailErr || mobileErr || countryErr || passwordErr || confirmPasswordErr) == true) {
        return false;
    } else {
