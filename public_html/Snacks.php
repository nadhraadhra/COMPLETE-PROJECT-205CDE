...
<title>E-DriveThru Vending Snacks</title>
...
<div class="col-md-10 mb-5 text-center">
          <ul class="product-category">
              ...
              <li><a href="Snacks.php"class="active">Snacks</a></li>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="image/kitkat2.jpg" class="img-prod"><img class="img-fluid" src="image/kitkat2.jpg" alt="snack">
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_kitkat" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="kitkat" product="Kit Kat" sel="2.00">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="image/snickers.png" class="img-prod"><img class="img-fluid" src="image/snickers.png" alt="snack">
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_snickerfun" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="snickerfun" product="Snickers Fun Size " sel="4.00">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="image/snicker2.png" class="img-prod"><img class="img-fluid" src="image/snicker2.png" alt="snacks">
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_snickerminis" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="snickerminis" product="Snicker Minis" sel="3.50">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="image/kinderbeuno.jpg" class="img-prod"><img class="img-fluid" src="image/kinderbeuno.jpg" alt="Kinder Beuno">
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_kinder" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="kinder" product="Kinder Beuno" sel="3.20">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="image/kinderbeuno.jpg" class="img-prod"><img class="img-fluid" src="image/kinderbeuno.jpg" alt="Doritos">
<div class="overlay"></div>
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_doritos" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="doritos" product="Taco Doritos" sel="4.00">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="image/fritos.png" class="img-prod"><img class="img-fluid" src="image/fritos.png" alt="Fritos">
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_fritos" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="fritos" product="Taco Doritos" sel="4.00">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="image/toblerone.png" class="img-prod"><img class="img-fluid" src="image/toblerone.png" alt="choco">
     <span class="status">30%</span>
<div class="overlay"></div>
     </a>
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_toblerone" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="toblerone" product="Toblerone" sel="3.20">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="image/ritter.jpg" class="img-prod"><img class="img-fluid" src="image/ritter.jpg" alt="choco">
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_peppermint" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="peppermint" product="RS Peppermint" sel="4.00">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="image/ritter3.jpg" class="img-prod"><img class="img-fluid"  src="image/ritter3.jpg" alt="food">
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_darkchoco" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="darkchoco" product="RS Dark Choco" sel="4.00">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="image/ritter2.jpg" class="img-prod"><img class="img-fluid"  src="image/ritter2.jpg" alt="choco">
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_hazelnut" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="hazelnut" product="RS Hazelnut" sel="4.00">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="block-27">
     ...
     <li><a href="Noodles.html">3</a></li>
     <li><a href="Beverages.html">4</a></li>
     <li><a href="Others.html">5</a></li>
     <li><a href="#">&gt;</a></li>
     </ul>
</div>
</div>
...
<div class="ftco-footer-widget mb-4 ml-md-5">
     <h2 class="ftco-heading-2">Menu</h2>
          <ul class="list-unstyled">
              ...
              <li><a href="ContactUs.phpl" class="py-2 d-block">Contact Us</a></li>
          </ul>
</div>
</div>
...
<div class="col-md-12 text-center">
     <h6>Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="" target="_blank">Nadhrah</a>
     </h6>
</div>
</div>
</div>
