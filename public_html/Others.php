...
<title>E-DriveThru Vending Others</title>
...
<div class="dropdown-menu" aria-labelledby="dropdown05">
    ...
    <a class="dropdown-item" href="Special-Deals.phpS">Today's Specials</a>
 </div>
       </li>
...
<!--- ======================================   Hero Part  ==================================== --->
<div class="hero-wrap hero-bread" style="background-image: url('image/kitkat.jpg');">
<div class="container">
...
<div class="product">
     <a href="#" class="img-prod"><img class="img-fluid" src="image/ori.png" alt="Tomyam">
...
<div class="quantity-input">
    ...
    <input id="text_ori" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="ori" product="Perrier Mineral Water" sel="3.60">
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="#" class="img-prod"><img class="img-fluid" src="image/grape.png" alt="Perrier Drinking Water">
<div class="overlay"></div>
     </a>
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_p-grape" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="p-grape" product="Pierrer Mineral Grape" sel="3.60">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="#" class="img-prod"><img class="img-fluid" src="image/green.png" alt="Perrier Drinking Water">
<div class="overlay"></div>
     </a>
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_p-apple" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="p-apple" product="Pierrer Mineral Apple" sel="3.60">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="#" class="img-prod"><img class="img-fluid" src="image/cucumber.png" alt="Spindrift Cucumber">
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_cucumber" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="cucumber" product="Spindrift Cucumber Water" sel="2.80">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="#" class="img-prod"><img class="img-fluid" src="image/raspberry.png" alt="Spindrift Raspberry">
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_rspberry" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="raspberry" product="Spindrift Raspberry Water" sel="2.80">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="#" class="img-prod"><img class="img-fluid" src="image/lime.png" alt="Spindrift lime">
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_lime" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="lime" product="Spindrift Lime Carbonate Water" sel="2.80">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="#" class="img-prod"><img class="img-fluid" src="image/cranberry.png" alt="Spindrift Cranberry">
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_cranberry" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="cranberry" product="Spindrift Cranberry Water" sel="2.80">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="#" class="img-prod"><img class="img-fluid" src="image/cheetos4.png" alt="Cheetos Crunchy XXTRA HOT">
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_c-xxtra" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="c-xxtra" product="Cheetos Crunchy XXTRA HOT" sel="4.00">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="#" class="img-prod"><img class="img-fluid" src="image/cheetos1.png" alt="Cheetos Crunchy Cheese ">
<div class="overlay"></div>
     </a>
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_c-cheese" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="c-cheese" product="Cheetos Crunchy Cheese" sel="4.00">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="#" class="img-prod"><img class="img-fluid" src="image/cheetos3.png" alt="Cheetos Crunchy Mix ">
<div class="overlay"></div>
     </a>
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_c-mix" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="c-mix" product="Cheetos Crunchy Mix" sel="4.00">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="ftco-footer-widget mb-4 ml-md-5">
     <h2 class="ftco-heading-2">Menu</h2>
          ...
          <li><a href="Contact Us.html" class="py-2 d-block">Contact Us</a></li>
          </ul>
</div>
</div>
