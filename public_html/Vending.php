...
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Raleway+Dots"type="text/css">
...
<div class="col-md-9 ftco-animate text-center">
     ...
     <h1 class="mb-0 bread">Available Vending</h1>
</div>
</div>
</div>
</div>
...
<div class="TCN Vending">
    <a href="shop.php">
    <img src="image/tcn.png" class="img-fluid" aria-hidden="true"></>
    </a>
</div>
    <span>TCN Vending</span>
   </li>
    
   <li>
<div class="Yokai">
    <a href="Snacks.php">
    <img src="image/yokai.jpg" class="img-fluid"  aria-hidden="true"></>
    </a>
</div>
    <span>Yo-Kai Vending</span>
  </li>
    
    
  <li>
<div class="Atlas Vending">
    <a href="Noodles.php">
    <img src="image/Atlas copy.png" class="img-fluid"  aria-hidden="true"></>
    </a>
</div>
    <span>Atlas Vending</span>
  </li>
    
  <li>
<div class="Express vending">
    <a href="Beverages.php">
    <img src="image/express.jpg" class="img-fluid" aria-hidden="true"></>
    </a>
</div>
    <span>Express Vending</span>
  </li>
    
  <li>
<div class="Easy Vend">
    <a href="Snack Deals.php">
    <img src="image/ezyvend.jpg" class="img-fluid" aria-hidden="true"></>
    </a>
</div>
    <span>Easy Vend</span>
  </li>
