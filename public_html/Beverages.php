...
<div class="col-md-9 ftco-animate text-center">
     ...
     <h1 class="mb-0 bread">Beverages</h1>
</div>
</div>
</div>
</div>
...
<div class="col-md-10 mb-5 text-center">
          ...
          <li><a href="Beverages.php" class="active">Beverages</a></li>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="image/tonic.png" class="img-prod"><img class="img-fluid" src="image/tonic.png" alt="F&N Tonic ">
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_fn_tonic" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="fn_tonic" product="F&N Tonic Water" sel="2.20">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="image/GrassJelly.png" class="img-prod"><img class="img-fluid" src="image/GrassJelly.png" alt="Grass Jelly Drink">
<div class="overlay"></div>
     </a>
    
<div class="text py-3 pb-4 px-3 text-center">
     <h3 class="product-title">F&N Grass Jelly</h3>
<div class="d-flex-center">
<div class="product-price">
     <p class="price"><span class="product-price">RM2.00</span></p>
</div>
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_grassjelly" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="grassjelly" product="F&N Grass Jelly" sel="2.00">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="image/oyoshi.png" class="img-prod"><img class="img-fluid" src="image/oyoshi.png" alt="Oyoshi Drinks">
<div class="overlay"></div>
     </a>
    
<div class="text py-3 pb-4 px-3 text-center">
     <h3 class="product-title">Oyoshi Black Tea</h3>
<div class="d-flex-center">
<div class="product-price">
     <p class="price"><span class="product-price">RM2.50</span></p>
</div>
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_blacktea" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="blacktea" product="Oyoshi Black Tea" sel="2.50">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="image/mango.png" class="img-prod"><img class="img-fluid" src="image/mango.png" alt="Season Mango">
<div class="overlay"></div>
     </a>
    
<div class="text py-3 pb-4 px-3 text-center">
     <h3 class="product-title">Season Mango</a></h3>
<div class="d-flex-center">
<div class="product-price">
     <p class="price"><span class="product-price">RM2.50</span></p>
</div>
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_mango" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="mango" product="Season Mango" sel="2.50">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="image/FT4.png" class="img-prod"><img class="img-fluid" src="image/FT4.png" alt="FT Orange">
<div class="overlay"></div>
     </a>
    
<div class="text py-3 pb-4 px-3 text-center">
     <h3 class="product-title">Fruit Tree Orange</a></h3>
<div class="d-flex-center">
<div class="product-price">
     <p class="price"><span class="product-price">RM2.50</span></p>
</div>
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_ft-orange" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="ft-orange" product="Fruit Tree Orange" sel="2.50">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="image/FT3.png" class="img-prod"><img class="img-fluid" src="image/FT3.png" alt="FT Lychee">
<div class="overlay"></div>
     </a>
    
<div class="text py-3 pb-4 px-3 text-center">
     <h3 class="product-title">Fruit Tree Lychee</a></h3>
<div class="d-flex-center">
<div class="product-price">
     <p class="price"><span class="product-price">RM2.50</span></p>
</div>
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_ft-lychee" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="ft-lychee" product="Fruit Tree Lychee" sel="2.50">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="image/FT2.png" class="img-prod"><img class="img-fluid" src="image/FT2.png" alt="FT Mango">
<div class="overlay"></div>
     </a>
    
<div class="text py-3 pb-4 px-3 text-center">
     <h3 class="product-title">Fruit Tree Mango</a></h3>
<div class="d-flex-center">
<div class="product-price">
     <p class="price"><span class="product-price">RM2.50</span></p>
</div>
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_ft-mango" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="ft-mango" product="Fruit Tree Mango" sel="2.50">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="col-md-6 col-lg-3 grid-item ftco-animate">
<div class="product">
     <a href="image/FT1.png" class="img-prod"><img class="img-fluid" src="image/FT1.png" alt="FT Apple Aloe Vera">
<div class="overlay"></div>
     </a>
    
<div class="text py-3 pb-4 px-3 text-center">
     <h3 class="product-title">Fruit Tree Aloe Vera</a></h3>
<div class="d-flex-center">
<div class="product-price">
     <p class="price"><span class="product-price">RM2.50</span></p>
</div>
...
<div class="quantity-input">
    <input class="minus btn d-flex justify-content-center align-items-center mx-1" type="button" value="-">
    <input id="text_ft-aloe" value="1" class="input-text qty text" size="4"/>
    <input class="plus btn d-flex  align-items-center mx-1" type="button" value="+">
</div>
      
     <button class="btn btn-success add-to-cart-button " rel="ft-aloe" product="Fruit Tree Aloe Vera" sel="2.50">
     <span><i class="ion-ios-cart"></i></span>
     </button>
...
<div class="ftco-footer-widget mb-4 ml-md-5">
     <h2 class="ftco-heading-2">Menu</h2>
          ...
          <li><a href="About.phpl" class="py-2 d-block">About</a></li>
