...
<title>E-DriveThru Vending Checkout</title>
...
<div class="col-md-9 ftco-animate text-center">
     <p class="breadcrumbs"><span class="mr-2"><a href="HomePage.php">Home</a></span> <span>Checkout</span></p>
...
<form name="checkoutForm" action="/submit.php" onsubmit="return checkoutForm()"class="billing-form" method="post">
     <h3 class="mb-4 billing-heading">Billing Details</h3>
<div class="row align-items-end">
<div class="col-md-6">
<div class="form-group">
     <label for="firstname">First Name</label>
     <input type="text" name="Firs Name" class="form-control">
</div>
</div>
...
<!--- ************************************** End of Cart Total Part *************************************************  --->


<!--- ************************************** Payment Method Part *************************************************  --->
<div class="col-md-12">
<div class="cart-detail p-3 p-md-4" role="dialog" aria-hidden="true">
     <h3 class="billing-heading mb-4">Payment Method</h3>
<div class="form-group">
<div class="col-md-12">
<div class="radio-inline">
     <label><input type="radio" name="inlineRadioOptions" id="inlineRadio1" value="Select your e-wallet (BigPay/Touch n' go and etc)" class="mr-2"> E-Wallet </label>
</div>
</div>
</div>
...
<div class="col-md-12">
<div class="radio">
     <label><input type="radio" name="inlineRadioOptions" id="inlineRadio2" value="Insert your detail of card/ debit card" class="mr-2"> Credit or debit card</label>
</div>
</div>
</div>
